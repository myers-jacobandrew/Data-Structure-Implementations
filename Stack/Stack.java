/*
	...
	Jacob Myers
  This is a Java implementation of a stack data structure that I wrote. 
  It allows for the creation of a stack with a specified size, and provides methods for pushing elements onto the top of the stack, popping elements off the top of the stack, and displaying the current contents of the stack. The program reads in a file containing a series of push and pop operations, and executes those operations on the stack. 
  It then displays the contents of the stack after each operation.
